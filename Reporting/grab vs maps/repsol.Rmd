...
df_grab_sel = 
  df_grab %>% 
  select(kota,nama_merchant_clean) %>% 
  distinct() 

df_grab_sel$nama_merchant_clean %>% unique()

setdiff(trimws(df_grab_sel$nama_merchant_clean),
        trimws(simi_simi$grab))
```
